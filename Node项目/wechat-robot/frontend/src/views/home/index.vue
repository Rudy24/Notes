<!--
 * @Author: your name
 * @Date: 2020-12-15 10:50:21
 * @LastEditTime: 2020-12-16 17:03:41
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \vehicle-mp\src\views\home\index.vue
-->
...
export default defineComponent({
  ...
  setup () {
    const myChartFn = () => {
      ...
      function generateRandom (lower: any, upper: any, fixed: any) {
      ...
      function createFormatter (
        ...
        const time =
          (hour < 10 ? '0' + hour : hour) + ':' + (minite < 10 ? '0' + minite : minite)
