...
6. 理解es6 `class`构造以及继承的底层实现原理
    ...
    让我们来看看通过`babel`转换的`Animal`类，是否跟上面es5类似呢？
...
7. 如何处理循环的异步操作;
    如果需要简单的处理下for循环的异步操作，就是让每个循环体拥有自己的作用域，可以利用`es6`中的`let`或者闭包来解决。
    ```javascript
    ...
    - [for循环异步操作问题小结](https://www.jianshu.com/p/550571aee1ad)
...
1. 为何try里面放return，finally还会执行，理解其内部机制
    - [JavaScript try-catch语句（错误处理）](https://www.cnblogs.com/iceflorence/p/6593139.html)
2. JavaScript如何实现异步编程，可以详细描述EventLoop机制
    - [JavaScript异步编程](https://my.oschina.net/u/3451529/blog/887335)
3. 宏任务和微任务分别有哪些
